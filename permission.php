<?php
    ...
    if (!$PermissionUser->is_loggedin())
    {
       $PermissionUser->redirect('index.php');
    }
    ...
    if (isset($_REQUEST['save']))
    {
		...
		if(!empty($nom) AND $status != "")
		{ 
			
			if ($PermissionUser->doInsertPermission($nom, $datecreation , $status)) 
			{
				$user->redirect('succes.php?q=permission');
			
			} 
			else 
			{
				
				$user->redirect('echec.php?q=permission');
...
<div id="wrap" class="">
	...
	<div id="page-body" class="page-width container ">
		...
		<?php
			...
			{
				$updateId = $_GET['id'];
				$myPermissionIs = $PermissionUser->getPermissionById($updateId);
				
				if(count($myPermissionIs) > 0)
				{
					...
					if (isset($_REQUEST['modifier']) AND isset($_GET['q']) && $_GET['q']=='u')
					{
						...
						if(!empty($nom) AND $status != '')
						{
							...
							if ($PermissionUser->doUpdatePermissionById($nom, $status, $updateId)) 
							{
								$user->redirect('succes.php?q=permission');							
							} 
							else 
						...
						<div class="action-bar bottom topic-actions view-topic  ">
							...
							<div class="float-left">
								...
								<div class="btn btn-default navbar-btn">
									<a href="/home.php"> Total : &nbsp;&nbsp;<span class="badge">1</span></a>
								</div>
							...
							<div class="float-right">
								...
								<div class="btn btn-default navbar-btn">
									<a href="/permission.php" >Retour a la liste</a>
								</div>
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="panel panel-default">
									<div class="panel-heading"><h3 style="color:white;">Modifier '.$myPermissionIs['name'].'</h3> </div>
										...
										<div class="col-md-6 col-md-6-form" style="margin-left:10%;">
											<form role="form" method="post" action="">
												...
												<div class="form-group">
													<label>Label</label>
													<input type="text" name="nom" class="form-control" value="'.$myPermissionIs['name'].'">
												</div>
			...
			elseif (isset($_GET['q']) && $_GET['q']=='d')
			{
				...
				$myUserIs = $PermissionUser->getUserById($deleteId);
				...
				if (isset($_REQUEST['supprimer']) AND isset($_GET['q']) && $_GET['q']=='d')
				{
					...
					$delete = $PermissionUser->doDeleteUserById($status, $deleteId);
				...
				if($delBool)
				{
					echo'<center><div class="btn btn-default navbar-btn"><a href="/permission.php" >Retour a la liste</a></div></center>';
				}
				else
				{
					echo '
						...
						<form role="form" method="post" action="">
							...
							<div class="btn btn-default navbar-btn"><a href="/permission.php" >Annuler</a></div>
				...
				echo'
					...
					<div class="action-bar bottom topic-actions view-topic  ">
							...
							<div class="float-left">
								...
								<!--<div class="btn btn-default navbar-btn">
									<a href="/permission.php?q=add" class="">Ajouter</a>
								</div>-->
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="panel panel-default">
								<div class="panel-heading"><h3 style="color:white;">Ajouter un nouveau permission</h3> </div>
								<div class="panel-body">
									<div class="col-md-6 col-md-6-form" style="margin-left:10%;">
										<form role="form" method="post" action="">
				...
				echo '
					...
					<div class="action-bar bottom topic-actions view-topic  ">
						...
						<div class="float-left">
							...
							<div class="btn btn-default navbar-btn">
								<a href=""> Total : &nbsp;&nbsp;<span class="badge">'.$PermissionUser->doPermissionCount().'</span></a>
							</div>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="panel panel-default">
								<div class="panel-heading"><h3 style="color:white;">Liste des permissions</h3> </div>
								<div class="panel-body">
									...
									<table class="table table-bordred table-striped" data-toggle="table" data-url="table.permission.php"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="asc">
