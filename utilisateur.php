<?php
    ...
    if (isset($_REQUEST['connexion']))
    {
        ...
        $register = $user->doRegister($nom, $sexe, $email, $telephone, $password, $status, $role);
        
        if ($register) 
        {
            $user->redirect('succes.php?q=utilisateur');
        
        } 
        else 
        {
            
            $user->redirect('echec.php?q=utilisateur');
...
<div id="wrap" class="">
	...
	<div id="page-body" class="page-width container ">
		...
		<?php
			...
			{
				$updateId = $_GET['id'];
				$myUserIs = $user->getUserById($updateId);
				
				//print_r($myUserIs);
				
				if(count($myUserIs) > 0)
				{
					$theRoles = $user->getAllRoles();
					...
					if (isset($_REQUEST['modifier']) AND isset($_GET['q']) && $_GET['q']=='u')
					{
						...
						if(!empty($nom) OR !empty($sexe) OR !empty($email) OR !empty($telephone) OR $status != "")
						{
							if ($user->doUpdateUserById($nom, $sexe, $email, $telephone, $status, $updateId, $role)) 
							{
								$user->redirect('succes.php?q=utilisateur');
					...
					echo'
						...
						<div class="action-bar bottom topic-actions view-topic  ">
								...
								<div class="float-right">
									...
									<div class="btn btn-default navbar-btn">
										<a href="/utilisateur.php" >Retour a la liste</a>
									</div>
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="panel panel-default">
									<div class="panel-heading"><h3 style="color:white;">Modifier '.$myUserIs['fullname'].'</h3> </div>
										...
										<div class="col-md-6 col-md-6-form" style="margin-left:10%;">
											<form role="form" method="post" action="">
												...
												<div class="form-group">
													...
													<input type="text" name="nom" class="form-control" value="'.$myUserIs['fullname'].'">
												</div>
												...
												<div class="form-group">
													<label>Email</label>
													<input type="email" name="email" class="form-control" value="'.$myUserIs['email'].'">
												</div>
												
												<div class="form-group">
													<label>Telephone</label>
													<input type="tel" name="telephone" class="form-control" value="'.$myUserIs['phone'].'" >
												</div>
			...
			elseif (isset($_GET['q']) && $_GET['q']=='d')
			{
				...
				$myUserIs = $user->getUserById($deleteId);
				...
				if (isset($_REQUEST['supprimer']) AND isset($_GET['q']) && $_GET['q']=='d')
				{
					...
					$delete = $user->doDeleteUserById($status, $deleteId);
				...
				if($delBool)
				{
					echo'<center><div class="btn btn-default navbar-btn"><a href="/utilisateur.php" >Retour a la liste</a></div></center>';
				}
				else
				{
					echo '
						...
						<form role="form" method="post" action="">
							...
							<div class="btn btn-default navbar-btn"><a href="/utilisateur.php" >Annuler</a></div>
				...
				echo'
					...
					<div class="action-bar bottom topic-actions view-topic  ">
							...
							<div class="float-left">
								...
								<!--<div class="btn btn-default navbar-btn">
									<a href="/utilisateur.php?q=add" class="">Ajouter</a>
								</div>-->
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="panel panel-default">
								<div class="panel-heading"><h3 style="color:white;">Ajouter un nouvel utilisateur</h3> </div>
								<div class="panel-body">
									<div class="col-md-6 col-md-6-form" style="margin-left:10%;">
										<form role="form" method="post" action="">
				...
				echo '
					...
					<div class="action-bar bottom topic-actions view-topic  ">
						...
						<div class="float-left">
							...
							<div class="btn btn-default navbar-btn">
								<a href=""> Total : &nbsp;&nbsp;<span class="badge">'.$user->doUserCount().'</span></a>
							</div>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="panel panel-default">
								<div class="panel-heading"><h3 style="color:white;">Liste des utilisateurs</h3> </div>
								<div class="panel-body">
									...
									<table class="table table-bordred table-striped" data-toggle="table" data-url="table.utilisateur.php"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="asc">
										<thead class="thead-inverse">
										<tr>
											<!--<th data-field="state" data-checkbox="true" >Item ID</th>-->
											<th data-field="id"     data-sortable="true">ID</th>
											<th data-field="fullname"   data-sortable="true">Nom Complet</th>
